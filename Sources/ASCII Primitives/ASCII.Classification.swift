...
extension ASCII.Classification {
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isWhitespace(0x20)    // true (SPACE)
    /// ASCII.Classification.isWhitespace(0x09)    // true (TAB)
    /// ASCII.Classification.isWhitespace(0x41)    // false ('A')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isControl(0x00)    // true (NUL)
    /// ASCII.Classification.isControl(0x0A)    // true (LF)
    /// ASCII.Classification.isControl(0x7F)    // true (DEL)
    /// ASCII.Classification.isControl(0x41)    // false ('A')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isVisible(0x41)    // true ('A')
    /// ASCII.Classification.isVisible(0x30)    // true ('0')
    /// ASCII.Classification.isVisible(0x20)    // false (SPACE)
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isPrintable(0x41)    // true ('A')
    /// ASCII.Classification.isPrintable(0x20)    // true (SPACE)
    /// ASCII.Classification.isPrintable(0x0A)    // false (LF)
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isDigit(0x30)    // true ('0')
    /// ASCII.Classification.isDigit(0x39)    // true ('9')
    /// ASCII.Classification.isDigit(0x41)    // false ('A')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isHexDigit(0x30)    // true ('0')
    /// ASCII.Classification.isHexDigit(0x41)    // true ('A')
    /// ASCII.Classification.isHexDigit(0x61)    // true ('a')
    /// ASCII.Classification.isHexDigit(0x47)    // false ('G')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isLetter(0x41)    // true ('A')
    /// ASCII.Classification.isLetter(0x61)    // true ('a')
    /// ASCII.Classification.isLetter(0x30)    // false ('0')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isUppercase(0x41)    // true ('A')
    /// ASCII.Classification.isUppercase(0x5A)    // true ('Z')
    /// ASCII.Classification.isUppercase(0x61)    // false ('a')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isLowercase(0x61)    // true ('a')
    /// ASCII.Classification.isLowercase(0x7A)    // true ('z')
    /// ASCII.Classification.isLowercase(0x41)    // false ('A')
    /// ```
    @_transparent
    ...
    ///
    /// ```swift
    /// ASCII.Classification.isAlphanumeric(0x41)    // true ('A')
    /// ASCII.Classification.isAlphanumeric(0x30)    // true ('0')
    /// ASCII.Classification.isAlphanumeric(0x21)    // false ('!')
    /// ```
    @_transparent
